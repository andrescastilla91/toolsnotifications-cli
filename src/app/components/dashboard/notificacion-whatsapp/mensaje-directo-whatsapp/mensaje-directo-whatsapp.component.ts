...
import { modelFormMensajeDirectoWhatsapp, modelMensajeDirectoWhatsappApiRequest, modelTipoMensajeWhatsappApiResponse } from 'src/app/models/notificacion-whatsapp/model-mensaje-whatsapp.models';
...
export class MensajeDirectoWhatsappComponent implements OnDestroy, OnInit{
  ...
  private getListarTipoMensajeWhatsapp():void{
    ...
    this.cancelSuscripcion.push(
      this._mensajeDirectoWhatsappService.getListarTipoMensajeWhatsapp()
      .subscribe((resp) => {
